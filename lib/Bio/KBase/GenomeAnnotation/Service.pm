...
our %method_authentication = (
        ...
        'annotate_special_proteins_v2' => 'none',
        ...
        'annotate_subspecies_classification' => 'none',
        'annotate_subclade' => 'none',
        'remove_genbank_features' => 'none',
        'annotate_strain_type_MLST' => 'none',
        'annotate_strain_type_MLST_v2' => 'none',
        'annotate_strain_type_cgMLST' => 'none',
        'compute_cdd' => 'none',
